// Sequelize 패키지 -> Sequlize 객체를 생성하고 PostgreSQL과의 연결을 관리
...
const sequelize = new Sequelize(config.database, config.password, config.password, config);
...
Comment.initiate(sequselize); // Comment 모델을 초기화하고 연결 설정을 전달하여 데이터베이스와 연결
